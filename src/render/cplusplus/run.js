...
function createWasm() {
  ...
  function instantiateAsync() {
    if (!wasmBinary &&
      ...
      fetch(`safe-file-protocol:://${wasmBinaryFile}`, { credentials: 'same-origin' }).then(function (response) {
...
var asmGlobalArg = {};
var asmLibraryArg = { "abort": _abort, "emscripten_get_sbrk_ptr": _emscripten_get_sbrk_ptr, "emscripten_memcpy_big": _emscripten_memcpy_big, "emscripten_resize_heap": _emscripten_resize_heap, "emscripten_run_script_int": _emscripten_run_script_int, "memory": wasmMemory, "table": wasmTable };
var asm = createWasm();
/** @type {function(...*):?} */
var ___wasm_call_ctors = Module["___wasm_call_ctors"] = createExportWrapper("__wasm_call_ctors");

/** @type {function(...*):?} */
var _hi = Module["_hi"] = createExportWrapper("hi");
